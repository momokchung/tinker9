...
private:
   ...
   inline void tetvorder(double ra2,double rb2,double rc2,double rd2,
      ...
      double rbd2, double rcd2, double tetvorder, double* cos_ang, double* sin_ang,
      double deriv[6][6], double& vola, double& volb, double& volc,
      double& vold, double* dvola, double* dvolb, double* dvolc, double* dvold);

   inline double tetra_volume(double r12sq, double r13sq, double r14sq, double r23sq, double r24sq, double r34sq);
};
}
