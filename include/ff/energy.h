...
TINKER_EXTERN grad_prec* gx; ///< Gradient of valence terms; also works as total gradient array. NN valence terms also use this to store their gradients.
TINKER_EXTERN grad_prec* gy; ///< Gradient of valence terms; also works as total gradient array. NN valence terms also use this to store their gradients.
TINKER_EXTERN grad_prec* gz; ///< Gradient of valence terms; also works as total gradient array. NN valence terms also use this to store their gradients.
...
TINKER_EXTERN EnergyBuffer eng_buf;      ///< Energy buffer for the valence terms, including NN valence term.
...
TINKER_EXTERN VirialBuffer vir_buf;      ///< Virial buffer for the valence terms, including NN valence term. Note Viral for NN has not been implemented yet.
