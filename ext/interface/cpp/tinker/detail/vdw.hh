...
extern double*& yred;
extern double*& zred;
extern double*& radvdw;
extern double*& epsvdw;
...
extern "C" double* TINKER_MOD(vdw, radvdw);
extern "C" double* TINKER_MOD(vdw, epsvdw);
...
double*& radvdw = TINKER_MOD(vdw, radvdw);
double*& epsvdw = TINKER_MOD(vdw, epsvdw);
