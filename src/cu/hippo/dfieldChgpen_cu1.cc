   ...
   real aewald)
{
   ...
   __shared__ real ci[BLOCK_DIM], dix[BLOCK_DIM], diy[BLOCK_DIM], diz[BLOCK_DIM], qixx[BLOCK_DIM], qixy[BLOCK_DIM],
      qixz[BLOCK_DIM], qiyy[BLOCK_DIM], qiyz[BLOCK_DIM], qizz[BLOCK_DIM], corei[BLOCK_DIM], alphai[BLOCK_DIM],
      vali[BLOCK_DIM];
   real xi, yi, zi;
   real xk, yk, zk, ck, dkx, dky, dkz, qkxx, qkxy, qkxz, qkyy, qkyz, qkzz, corek, alphak, valk;
   real fidx, fidy, fidz;
   real fkdx, fkdy, fkdz;
